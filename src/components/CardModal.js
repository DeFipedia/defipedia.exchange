        ...
        >
            <div className='dynamic-pricing-modal'>
                ...
                <section class='dynamic-pricing-modal-content'>
                    ...
                    {/* --------- */}
                    <h4>$BOOKS on <a href='https://uniswap.exchange/' target='_blank'>UniSwap</a></h4>
                    ...
                    <h4>$BOOKS on Auction</h4>
                        <p>Tokens at auction will start at $1,000 USD per $BOOKS. As time passes, the listing price will decay to $200 USD. Learn more about the time based 
                            <a href='https://docs.google.com/spreadsheets/d/e/2PACX-1vQCpeDTE3s66xtUC8X5h7Vq5hVdiU4UbBN9ifeQBCFWizwtELh6XWZyKCH9parPRjdXBZQq_wRuwqft/pubchart?oid=1626226558&amp;format=interactive%22%3E' target='_blank'> price mechanism here.</a>
                        </p>
                    {/* --------------- */}
                    ...
                    <p>Got any questions? You can reach out on 
                        <a href='https://twitter.com/defipedia' target='_blank'> Twitter</a>, 
                        <a href='https://t.co/BpnWdjbOyP?amp=1' target='_blank'> Telegram</a>, or 
                        <a href='https://discord.gg/SQUNG5' target='_blank'> Discord</a></p>
                </section>
            </div>
        </Modal>
    )
