import { Button, Modal, ModalCloseButton, ModalContent, ModalHeader, ModalOverlay, useDisclosure, Box, Text, Image, Center } from "@chakra-ui/react";
import React  from "react";// import React, {useState} from 'react';
import SaleCard from "./SaleCard";

export default function BuyModal({size='md'}) {
    const {isOpen, onOpen, onClose} = useDisclosure()
    return(
        <>
        <Button size={size} variant='solid' onClick={onOpen} colorScheme='secondary'>Buy</Button>
        ...
        <ModalOverlay>
            ...
            <Box mt='75px'>
                ...
                <SaleCard title='Buy' image={process.env.PUBLIC_URL + 'assets/books-presale.png'} />
                <Button size='md' colorScheme='primary' mt='80px'>Buy</Button>
            </Box>
